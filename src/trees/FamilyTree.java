...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        {
            // Check if this node has the target name
            ...
            for (TreeNode child : children) {
                ...
                if (found != null) {
                    return found; // If found, return the node
                }
            }
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            TreeNode currentNode = this; // Start from this node
            
            // Traverse up the tree until reaching the root
            while (currentNode != null) {
                ancestors.add(currentNode); // Add current node to ancestors
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
	    ...
	    // Check members of ancestorsOf1 in order until finding a common ancestor
